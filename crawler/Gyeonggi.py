...
def keywords_get_URL(keyword):
    ...
    driver.get("http://www.kyeonggi.com/?mod=search&act=engine&cust_div_code=&searchContType=article&searchWord=%ED%99%8D%EC%88%98&fromDate=&toDate=&sfield=&article_type=&sort=date")
