...
def keywords_get_URL(keyword):
    ...
    driver.get("http://www.cctoday.co.kr/?mod=search&act=engine&sc_code=&sc_area=A&sc_article_type=&sc_view_level=&sc_sdate=2017-07-04&sc_edate=2018-07-04&searchWord=%ED%99%8D%EC%88%98")
